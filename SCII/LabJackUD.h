...
const long LJ_ioGET_AIN_DIFF = 15; // U3 only.  Put negative channel in x1.  If 32 is passed as x1, Vref will be added to the result. 
...
const long LJ_ioSPI_COMMUNICATION = 503; // UE9 + U3

const long LJ_ioI2C_COMMUNICATION = 504; // UE9 + U3
const long LJ_ioASYNCH_COMMUNICATION = 505; // UE9 + U3
const long LJ_ioTDAC_COMMUNICATION = 506; // UE9 + U3
...
const long LJ_ioSET_EVENT_CALLBACK = 400;
...
const long LJ_chCAL_CONSTANTS = 400; // UE9 + U3
const long LJ_chUSER_MEM = 402; // UE9 + U3
...
const long LJ_chUSB_STRINGS = 404; // U3
...
const long LJ_chSHT_DATA_CHANNEL = 5002; // UE9 + U3. Default is FIO0
const long LJ_chSHT_CLOCK_CHANNEL = 5003; // UE9 + U3. Default is FIO1

// SPI related :
const long LJ_chSPI_AUTO_CS = 5100; // UE9 + U3
const long LJ_chSPI_DISABLE_DIR_CONFIG = 5101; // UE9 + U3
const long LJ_chSPI_MODE = 5102; // UE9 + U3
const long LJ_chSPI_CLOCK_FACTOR = 5103; // UE9 + U3
const long LJ_chSPI_MOSI_PIN_NUM = 5104; // UE9 + U3
const long LJ_chSPI_MISO_PIN_NUM = 5105; // UE9 + U3
const long LJ_chSPI_CLK_PIN_NUM = 5106; // UE9 + U3
const long LJ_chSPI_CS_PIN_NUM = 5107; // UE9 + U3

// I2C related :
// used with LJ_ioPUT_CONFIG
const long LJ_chI2C_ADDRESS_BYTE = 5108; // UE9 + U3
const long LJ_chI2C_SCL_PIN_NUM = 5109; // UE9 + U3
const long LJ_chI2C_SDA_PIN_NUM = 5110; // UE9 + U3
const long LJ_chI2C_OPTIONS = 5111; // UE9 + U3
const long LJ_chI2C_SPEED_ADJUST = 5112; // UE9 + U3

// used with LJ_ioI2C_COMMUNICATION :
const long LJ_chI2C_READ = 5113; // UE9 + U3
const long LJ_chI2C_WRITE = 5114; // UE9 + U3
const long LJ_chI2C_GET_ACKS = 5115; // UE9 + U3
const long LJ_chI2C_WRITE_READ = 5130; // UE9 + U3

// ASYNCH related :
// Used with LJ_ioASYNCH_COMMUNICATION
const long LJ_chASYNCH_RX = 5117; // UE9 + U3
const long LJ_chASYNCH_TX = 5118; // UE9 + U3
const long LJ_chASYNCH_FLUSH = 5128; // UE9 + U3
const long LJ_chASYNCH_ENABLE = 5129; // UE9 + U3

// Used with LJ_ioPUT_CONFIG and LJ_ioGET_CONFIG
const long LJ_chASYNCH_BAUDFACTOR = 5127; // UE9 + U3

// LJ TickDAC related :
const long LJ_chTDAC_SCL_PIN_NUM = 5119; // UE9 + U3:  Used with LJ_ioPUT_CONFIG
// Used with LJ_ioTDAC_COMMUNICATION
const long LJ_chTDAC_SERIAL_NUMBER = 5120; // UE9 + U3: Read only
const long LJ_chTDAC_READ_USER_MEM = 5121; // UE9 + U3
const long LJ_chTDAC_WRITE_USER_MEM = 5122; // UE9 + U3
const long LJ_chTDAC_READ_CAL_CONSTANTS = 5123; // UE9 + U3
const long LJ_chTDAC_WRITE_CAL_CONSTANTS = 5124; // UE9 + U3
const long LJ_chTDAC_UPDATE_DACA = 5125; // UE9 + U3
const long LJ_chTDAC_UPDATE_DACB = 5126; // UE9 + U3
...
const long LJ_chSTREAM_DISABLE_AUTORECOVERY = 4005; // U3
const long LJ_chSTREAM_SAMPLES_PER_PACKET = 4108;
const long LJ_chSTREAM_READS_PER_SECOND = 4109;
const long LJ_chAIN_STREAM_SETTLING_TIME = 4110; // U6
...
const long LJ_tcSYS = 1;      // UE9 & U3: system clock
...
const long LJ_chSWDT_RESET_COMM = 5203; // UE9 - Reset Comm on watchdog reset.  Write only. 
const long LJ_chSWDT_RESET_CONTROL = 5204; // UE9 - Reset Control on watchdog trigger.  Write only. 
const long LJ_chSWDT_UDPATE_DIOA = 5205; // UE9 & U3 - Update DIO0 settings after reset.  Write only. 
const long LJ_chSWDT_UPDATE_DIOB = 5206; // UE9 - Update DIO1 settings after reset.  Write only. 
const long LJ_chSWDT_DIOA_CHANNEL = 5207; // UE9 & U3 - DIO0 channel to be set after reset.  Write only. 
const long LJ_chSWDT_DIOA_STATE = 5208; // UE9 & U3 - DIO0 state to be set after reset.  Write only. 
const long LJ_chSWDT_DIOB_CHANNEL = 5209; // UE9 - DIO1 channel to be set after reset.  Write only. 
const long LJ_chSWDT_DIOB_STATE = 5210; // UE9 - DIO0 state to be set after reset.  Write only. 
const long LJ_chSWDT_UPDATE_DAC0 = 5211; // UE9 - Update DAC0 settings after reset.  Write only. 
const long LJ_chSWDT_UPDATE_DAC1 = 5212; // UE9 - Update DAC1 settings after reset.  Write only. 
...
2.59: Fixed bug causing some U3 timer values to report wrongly.  Also added support for OEMs to
      change USB string descriptors on the U3
...
2.76: Fixed bug with the proper range not always being used when streaming on a UE9,
	  Also fixed a bug with UE9 Ethernet ListAll() returning wrong values for IP addresses
2.77: Fixed bug with special channel readings while streaming, and added Asynch support for U3
...
3.05: Fixed calibration bug with eAIN on the U3-HV & U3-LV
